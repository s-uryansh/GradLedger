...
const cardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: 'Analytics',
    description: 'Track mentor mentee interactions and growth metrics on-chain.',
  ...
  },
  {
    color: '#060010',
    title: 'Integration',
    description: 'Connect favorite tools with Arweave for permanent decentralized storage.',
    label: 'Connectivity'
  },
  {
    color: '#060010',
